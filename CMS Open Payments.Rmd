...
cmspayments$Physician_Specialty <- within(cmspayments, X <- ifelse(nchar(as.character(cmspayments$Physician_Specialty))==0
                                                , "NA"
...
foo <- data.frame(do.call('rbind', strsplit(as.character(cmspayments$Physician_Specialty),'|',fixed=TRUE)))
